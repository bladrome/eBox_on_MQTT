 ...
 * Exception handlers.
 */
#define xPortPendSVHandler      PendSV_Handler      // added by tanglei
//#define xPortSysTickHandler     SysTick_Handler     // added by tanglei
#define vPortSVCHandler         SVC_Handler         // added by tanglei
